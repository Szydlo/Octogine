...
namespace Octo
{
    ...
    {
    public:
        Enivroment(const std::string& hdrPath);
        ~Enivroment();

        void setShader(const Shader* shader);
        void drawBackground(Camera* camera);

        Octo::Shader equirectShader;
    ...
    private:
        ...
        void initEquirectangularMap();;
        void initIrradianceMap();
        void initPrefilterMap();
        void initBrdtf();
        void resetViewport();

        VertexArray m_CubeVAO, m_QuadVAO;
        Buffer m_CubeBuffer, m_QuadBuffer;
